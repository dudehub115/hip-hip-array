...
symmetricalCapitals.forEach(function(capital) {
  console.log(capital);
});
...
fibonacciNumbers.forEach(function(number) {
    console.log(number);
});
...
studentCopy.forEach(function(value) {
    console.log(value);
});
...
const combinedColors = primaries.concat(secondaries);

combinedColors.forEach(function(color) {
    console.log(color);
});

console.log("Original primaries array:", primaries);
console.log("Original secondaries array:", secondaries);
